...
public class PlayerActivity extends Activity {
	...
	public static final String UPDATE_ACTION = "com.zzx.action.UPDATE_ACTION"; // 更新动作
	public static final String CTL_ACTION = "com.zzx.action.CTL_ACTION"; // 控制动作
	public static final String MUSIC_CURRENT = "com.zzx.action.MUSIC_CURRENT"; // 音乐当前时间改变动作
	public static final String MUSIC_DURATION = "com.zzx.action.MUSIC_DURATION";// 音乐播放长度改变动作
	public static final String MUSIC_PLAYING = "com.zzx.action.MUSIC_PLAYING"; // 音乐正在播放动作
	public static final String REPEAT_ACTION = "com.zzx.action.REPEAT_ACTION"; // 音乐重复播放动作
	public static final String SHUFFLE_ACTION = "com.zzx.action.SHUFFLE_ACTION";// 音乐随机播放动作
	public static final String SHOW_LRC = "com.zzx.action.SHOW_LRC"; // 通知显示歌词
	...
	public void play() {
		...
		repeat_none();
		Intent intent = new Intent();
		intent.setAction("com.zzx.media.MUSIC_SERVICE");
