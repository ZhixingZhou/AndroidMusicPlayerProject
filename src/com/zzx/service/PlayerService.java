...
public class PlayerService extends Service {
	...
	public static final String MUSIC_CURRENT = "com.zzx.action.MUSIC_CURRENT";	//当前音乐播放时间更新动作
	public static final String MUSIC_DURATION = "com.zzx.action.MUSIC_DURATION";//新音乐长度更新动作
